    ...
    def test_is_float(self):
        ...
        for test_data, result in test_cases:
            with self.subTest(test_data=test_data):
                self.assertEqual(IREngine._IREngine__isfloat(test_data), result, "Function __isfloat is not working with value: {}".format(test_data))
                log.info('Test for function __isfloat passed with value: {}, expected result: {}'.format(test_data, result))
